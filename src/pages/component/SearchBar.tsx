...
const SearchBar: React.FC<SearchBarProps> = ({ type }) => {
  ...
  return (
    <div>
      <div
        className={` max-w-screen-sm w-[100%] h-[56px] top-0  left-50% px-5 z-50 sticky flex items-center justify-around pl-3 leading-[56px] bg-white border-b border-[#E5E5E5]`}
      >
        <div className="w-[7.5%]">
          <button
            onClick={toBackClick}
        ...
        <input
          ...
          placeholder={
            type == 'place'
              ? '리뷰를 보고 싶은 장소를 입력해주세요!'
              : '찾고 싶은 사람의 닉네임을 입력하세요!'
          }
        />
